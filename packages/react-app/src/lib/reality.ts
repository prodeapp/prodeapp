...
import {TournamentFactory} from "../typechain";
...
export function getQuestionId(questionData: TournamentFactory.RealitioQuestionStruct, arbitrator: string, timeout: number, minBond: BigNumber, realitio: string, msgSender: string) {
