...
export function getInverseInterdependencies(matchesInterdependencies: MatchesInterdependencies): MatchesInterdependencies {
  let interdependencies: MatchesInterdependencies = {};
