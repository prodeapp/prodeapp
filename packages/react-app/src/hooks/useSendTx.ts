import {
  useContractWrite, UseContractWriteConfig,
  usePrepareContractWrite,
  UsePrepareContractWriteConfig,
  useWaitForTransaction, WriteContractMode,
} from "wagmi";
...
export const useSendRecklessTx = <TMode extends WriteContractMode = WriteContractMode, TAbi extends Abi | readonly unknown[] = Abi, TFunctionName extends string = string>({
    address,
    abi,
    functionName,
