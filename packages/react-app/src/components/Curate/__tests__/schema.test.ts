...
const ROUND_ROBIN_1 = {
  "description": "International men's football championship contested by the national teams of the member associations of FIFA. Includes only the group phase matches.",
  "formats": [
    {
      "type": "groups",
...
const GROUPS_1 = {
  "description": "After the Ukraine invasion, many Russian athletes have been barred from competing in sporting events and Russia has been banned as a host to some of them. This is a mix of questions regarding said bans.",
  "formats": [
    {
      "type": "groups",
      "questions": [
...
const COMPLEX_1 = {
  "description": "International men's football championship contested by the national teams of the member associations of FIFA.",
  "formats": [
